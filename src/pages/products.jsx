...
export async function getServerSideProps({ query }) {
  ...
  try {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/product?page=${page}&category=${category}&brand=${brand}&rating=${rating}&minPrice=${minPrice}&maxPrice=${maxPrice}&limit=${productsPerPage}`
    );
    ...
    // Calculate totalPages based on total products count
